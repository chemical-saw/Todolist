...
class _UpdatePageState extends State<UpdatePage> {
  ...
  Future updateTodo() async {
    // var url = Uri.https('7842-119-110-212-66.ngrok.io', '/api/post-todolist');
    var url = Uri.http('192.168.0.106:8000', '/api/update-todolist/$_v1');
  ...
  Future deleteTodo() async {
    // var url = Uri.https('7842-119-110-212-66.ngrok.io', '/api/post-todolist');
    var url = Uri.http('192.168.0.106:8000', '/api/delete-todolist/$_v1');
    Map<String, String> header = {"Content-type": "application/json"};
